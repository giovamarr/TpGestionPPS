    ...
    <div class="row align-items-center ">
        <div class="col d-block align-items-center justify-content-center col-md-8 mx-auto">
            <div class="p-2 grey">
                ...
                ?>
                <h2 class="pb-1 text-center" alt="Seguimiento de PPS"> <b>Seguimiento de PPS Nº <?php echo $seguimiento['idSeguimientos']; ?></b> </h2>
                <hr>
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="col-lg-12">
                            <form method="post" action="">
                                ...
                                <div class="form-group">
                                    <p><strong>Experiencias, Compliciones y Obstáculos</strong><input type="text" alt="Experiencias, Compliciones y Obstáculos" class="form-control" name="experiencias" value="<?php echo $seguimiento['experiencias']; ?>" readonly> </p>
                                </div>
                                <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <form action="../controllers/SeguimientosController.php?m=aprobarSegui" method="post">
                                    ...
                                    <button type="submit" class="btn btn-success btn-block" alt="aprobar">Aprobar</button>
                                </form>
                            </div>
                            <div class="col-lg-6">
                                <button type="button" class="btn btn-danger btn-block" data-toggle="modal" data-target="#desaprobarModal" alt="desaprobar">Desaprobar</button>
