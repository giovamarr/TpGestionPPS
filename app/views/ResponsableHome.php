    ...
    <div class="container px-4 py-4" id="hanging-icons">
        ...
        <div class="row g-4 py-4 row-cols-1 row-cols-lg-3 d-flex justify-content-center">
            ...
            <div class="card col-md m-2 menu">
                <div class="card-body">
                    <h3 class="card-title text-center">Definir Tutores de PPS</h3>
            ...
            <div class="card col-md m-2 menu">
                <div class="card-body">
                    <h3 class="card-title text-center">Registrar Aprobacion PPS</h3>
                    <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                    <div class="text-center">
                        <button type="submit" class="btn btn-primary " onclick="location.href='ResponsableRegisterAprovedPPS.php';">
                            <svg width="20" height="20" fill="currentColor" class="bi bi-arrow-right-circle-fill d-flex align-items-center justify-content-center">
                                <use xlink:href="#arrow"></use>
                            </svg>
                        </button>
            ...
            <div class="card col-md m-2 menu">
                <div class="card-body">
                    <h3 class="card-title text-center">Registrar Docentes</h3>
                    <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                    <div class="text-center">
                        <button type="submit" class="btn btn-primary " onclick="location.href='ResponsableRegistrationDocente.php';">
                            <svg width="20" height="20" fill="currentColor" class="bi bi-arrow-right-circle-fill d-flex align-items-center justify-content-center">
                                <use xlink:href="#arrow"></use>
                            </svg>
                        </button>
