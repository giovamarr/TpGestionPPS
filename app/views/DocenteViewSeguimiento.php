        ...
        <div class="col d-block align-items-center justify-content-center col-md-8 mx-auto">
            <div class="p-2 grey">
                <?php if (isset($_GET['id']) and isset($_GET['idP'])) {
                    ...
                    if ($seguimiento['aprobadoSeg'] == 1){
                        $seguimiento['aprobadoSeg'] = 'Aprobado';
                    }else if($seguimiento['aprobadoSeg'] == 2){
                        $seguimiento['aprobadoSeg'] = 'Rechazado';
                    }else{
                        $seguimiento['aprobadoSeg'] = 'Correccion pendiente';
                    }
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="col-lg-12">
                            <form method="POST" action="">
                                ...
                                <div class="form-group">
                                    <p><strong>Estado</strong><input 
                                            alt="Total de Horas Trabajadas" min="0" class="form-control"
                                            name="AprobadoSeg"
                                            value="<?php echo $seguimiento['aprobadoSeg']; ?>" readonly></p>
                                </div>
                            </form>
                        </div>
                            ...
                            <div class="col-lg-12">
                                ...
                                <form action="Volver">
                                    <input type="button" class="btn btn-secondary btn-block"
                                        onclick="location.href='DocenteViewDetailPPS.php';" value="Volver" alt="volver" />
                                </form>
                            </div>
                        </div>
